...
<template>
  <div class="home-view relative min-h-[calc(100vh-10rem)] flex items-center justify-center -mt-8">
    ...
    <div class="text-center max-w-4xl mx-auto px-4">
      ...
      <!-- 主标题 -->
      <h1
        class="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-6 animate-fade-in-up"
      ...
      <!-- 副标题 -->
      <p
        class="text-base md:text-lg text-gray-500 max-w-2xl mx-auto mb-12 leading-relaxed animate-fade-in-up"
      ...
      <!-- 核心数据指标 -->
      <div
        class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 max-w-3xl mx-auto mb-14 animate-fade-in-up"
      ...
      >
        <router-link
          to="/fund-estimate"
          class="btn-primary inline-flex items-center gap-2 text-base px-8 py-3.5"
        >
          开始估算
          <svg
            class="w-5 h-5"
        ...
        <router-link
          to="/realtime"
          class="btn-secondary inline-flex items-center gap-2 text-base px-8 py-3.5"
        >
          <svg
            class="w-5 h-5"
            fill="none"
      ...
      <!-- 技术栈展示 -->
      <div
        class="mt-16 pt-8 border-t border-white/[0.04] animate-fade-in-up"
        style="animation-delay: 700ms"
      >
        <p class="text-xs text-gray-600 uppercase tracking-[0.2em] mb-4">
          技术架构
        </p>
        <div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-gray-500">
          <span class="flex items-center gap-1.5"><span class="status-dot-online" />Vue 3 + Vite</span>
          <span class="flex items-center gap-1.5"><span class="status-dot-online" />TypeScript 5.7</span>
          <span class="flex items-center gap-1.5"><span class="status-dot-online" />Tailwind CSS 3.4</span>
          <span class="flex items-center gap-1.5"><span class="status-dot-online" />Pinia 状态管理</span>
          <span class="flex items-center gap-1.5"><span class="status-dot-online" />ECharts 可视化</span>
          <span class="flex items-center gap-1.5"><span class="status-dot-online" />RESTful API</span>
        </div>
      </div>
    </div>
  </div>
